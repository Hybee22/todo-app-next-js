...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Todo, [{
    ...
    value: function componentWillMount() {
      // let newTodo = {
      //   id: this.props.todos.map(todo => todo.id),
      //   title: this.props.todos.map(todo => todo.item)
      // };
      // const firstItems = [...this.state.items, newTodo];
      this.setState({
        items: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(this.state.items), [this.props.todos]),
...
//# sourceMappingURL=todo.js.da16cc807f198209bcf4.hot-update.js.map